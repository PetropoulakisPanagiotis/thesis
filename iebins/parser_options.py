...
# Train parser
train_parser = argparse.ArgumentParser(description='Scale-Aware SLAM PyTorch implementation.',
...
train_parser.add_argument('--d3vo_c', dest='d3vo_c', help='predict also the uncertainty for canonical depth with d3vo',
                          action='store_true')
...
train_parser.add_argument('--do_kb_crop', help='if set, crop input images as kitti benchmark images',
                          action='store_true')
train_parser.add_argument('--use_right', help='if set, will randomly use right images when train on KITTI',
                          action='store_true')
...
eval_parser.add_argument('--virtual_depth_variation', type=int,
                         help='0 for scale/shift, for 1 for scale regression and 2 for scale with bins', default='1')
...
eval_parser.add_argument(
    '--upsample_type', type=int,
    help='0 for torch, 1 for custom bilinear interpolation, 2 custom and weight**2 for uncertainty', default='1')
eval_parser.add_argument('--bins_type', type=int, help='0 for uniform, 1 for logarithmic', default='1')
...
eval_parser.add_argument('--do_kb_crop', help='if set, crop input images as kitti benchmark images',
                         action='store_true')
eval_parser.add_argument('--use_right', help='if set, will randomly use right images when train on KITTI',
                         action='store_true')
