...
class l1_d3vo_loss(nn.Module):
    def __init__(self, beta=0.5):
        super(l1_d3vo_loss, self).__init__()
        self.beta = beta
...
train_parser.add_argument('--loss_type',                 type=int,   help='0 for silog, 1 for l1, 2 for l1 and d3vo uncertainty', default=0)
