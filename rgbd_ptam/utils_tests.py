...
def test_1(args, frame_1, matched_measurements_1, class_id=0, max_iterations=0, gt_pose=None):
    ...
    for meas in matched_measurements_1:  
        ...
        # 3D Landmark #
        optimizer.add_point(index_point + points_start, pt.position, fixed=False)
    ...
    print("Scales\n")
    print(frame_1.scale_aware_frame.scales[class_id], frame_1.scale_aware_frame.scales[class_id])
