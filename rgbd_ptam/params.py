...
class Params(object):
    def __init__(self):
        self.feature_detector = cv2.GFTTDetector_create(
            maxCorners=800, minDistance=15.0, 
        ...
        self.local_window_size = 12
        self.keyframes_buffer_size = 5
        self.ba_max_iterations = 15

        self.min_tracked_points = 170
        self.min_tracked_points_ratio = 0.78
