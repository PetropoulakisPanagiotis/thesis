...
file_names = [
    'ate_rsme.png', 'ate_mean.png', 'ate_max.png', 'relative_trans_rsme.png', 'relative_trans_mean.png',
    'relative_trans_max.png', 'relative_rot_rsme.png', 'relative_rot_mean.png', 'relative_rot_max.png'
]
